...
def fetch_and_cache_data():
    ...
    if response.status_code == 200:
        ...
        with open("src/data/cache/all_genes.json", "w", encoding="utf-8") as f:
    ...
    if response.status_code == 200:
        ...
        with open("src/data/cache/all_categories.json", "w", encoding="utf-8") as f:
        ...
        with open("src/data/cache/detailed_categories.json", "w", encoding="utf-8") as f:
        ...
        with open("src/data/cache/gene_category_map.json", "w", encoding="utf-8") as f:
    ...
    try:
        ...
        with open("src/data/cache/protein_complex_map.json", "w", encoding="utf-8") as f:
